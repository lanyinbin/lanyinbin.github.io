...
const chaptersData = [
    ...
    },
    {
        ...
        math: [
            {
                type: 'choice',
                question: '海王星能装下地球，嘟嘟数了4个又数了3个，一共数了几个？',
                options: [
    ...
    },
    {
        ...
        math: [
            ...
            {
                type: 'fillin',
                question: '钻石雨下了8颗钻石，嘟嘟捡了5颗，还剩几颗？8 - 5 = ？',
                answer: 3,
                hint: '8减5等于3哦！'
            },
            {
            ...
            {
                type: 'sequential',
                question: '钻石雨下了6颗，嘟嘟捡了2颗，爸爸又找到了3颗，一共有几颗钻石？',
                expression: '6 - 2 + 3',
                answer: 7,
...
function showFinalBadge() {
    triggerStarFall();
    playAudio(neptuneAudio.finalBadge, '恭喜嘟嘟！你完成了全部6个章节的海王星探险！你获得了海王星探险家大徽章！');
